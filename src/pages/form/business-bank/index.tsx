      ...
      <div className="max-container !max-w-[319px]">
        ...
        <div className="flex flex-col gap-2">
          <div className="card p-[14px] bg-white rounded-[14px] border border-[#0499F6]">
            <div className="header flex justify-between items-center bg-gradient-to-l rounded-xl px-3 py-[6px] from-[#5B86E5] to-[#36D1DC]">
              ...
              <div
                className={`w-5 h-5 flex items-center justify-center rounded-full border border-[#006FFD] bg-primary`}
              >
